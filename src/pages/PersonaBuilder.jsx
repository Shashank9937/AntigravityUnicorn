...
export function PersonaBuilder() {
    ...
    return (
        <div>
                ...
                <div className="flex-col gap-6">
                    <div className="card animate-fade-in-up">
                        ...
                        <div className="form-group">
                            ...
                            <input name="primaryPain" className="form-input" style={{ borderColor: 'rgba(239, 68, 68, 0.3)' }} value={persona.primaryPain} onChange={handleChange} />
                        </div>
                        <div className="form-group">
            ...
            <div className="card animate-fade-in-up mt-6" style={{ borderColor: 'rgba(245, 158, 11, 0.3)' }}>
